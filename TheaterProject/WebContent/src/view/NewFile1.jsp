...
<link href="http://ticketimage.interpark.com/TicketImage/main/120612_detail/tk_calendar.css" rel="stylesheet">
	<script type="text/javascript">
		...
		function fnSelectPlayDate(nIndex, sPlayDate){
			var prevIndex = document.getElementById("hidCellIndex").value; //1
			if(prevIndex!="") {
...
<div class="cal_Wrap">
	...
	<div class="cal_move">
		<div>
			...
			<a href="javascript:fnChangeMonth('201702');" class="pre"><span>이전</span></a>
...
<td></td>
	...
	<form id="formCalendar" name="formCalendar" method="form" action="NewFile1.jsp">
