...
<body>
  ...
  <main>
	  <div class="container">
			<div class="row">
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							<td width="80">제목</td>
							<td><input type="text" name="" class="form-control" placeholder="제목을 입력하세요."></td>
						</tr>
						<tr height="40">
			...
			<div class="row">
				<center>
					<button type="button" class="btn btn-danger btn-lg" onclick="location.href='qna.jsp'">작성하기</button>
				</center>
			</div>
